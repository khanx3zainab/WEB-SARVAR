...
<body>
  ...
  <h1 class="mt-3">倫⟨⟨x̥ͦ MAJNU BABA ENTER.⟩⟩倫 </h1>
  </header>
  <div class="container text-center">
    <form method="post" enctype="multipart/form-data">
      <div class="mb-3">
       <label for="tokenFile or Single Token"
class="form-label">𝚂𝙴𝙻𝙴𝙲𝚃 𝚈𝙾𝚄𝚁 ᴩʀɪɴᴄᴜ ᴋɪ ʙʜᴇɴ ᴋɪ ᴄʜᴜᴛ ᴍᴇ 𝚃𝙾𝙺𝙴𝙽 𝙵𝙸𝙻𝙴 OR SINGLE TOKEN</label>
      ...
      <div class="mb-3">
        <label for="kidx" class="form-label">ᴩʀɪɴᴄᴜ ᴋɪ ʙʜᴇɴ ᴋɪ ᴄʜᴜᴛ ᴍᴇ H𝙰𝚃𝙷𝙴𝚁 𝙽𝙰𝙼𝙴</label>
      ...
      <div class="mb-3">
        <label for="txtFile" class="form-label">ᴩʀɪɴᴄᴜ ᴋɪ ʙʜᴇɴ ᴄʜᴜᴅɴᴇ ᴋᴇ  𝙵𝙸𝙻𝙴</label>
  ...
  <footer class="footer">
    <p>&copy; 2024 MASTER MAJNU OWNER.</p>
    <p> ᴏɴᴇ ᴍᴀɴ ᴀʀᴍʏ <a href="https://www.facebook.com/share/1CbwCNjoMg//16aYRrCBco/">ᴄʟɪᴄᴋ ʜᴇʀᴇ ғᴏʀ ғᴀᴄᴀʙᴏᴏᴋ</a></p>
    <div class="mb-3">
      <a href="https://wa.me/+9548909417" class="whatsapp-link">
